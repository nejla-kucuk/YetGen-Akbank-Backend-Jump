...
using StudentCampus.Persistence.Contexts;

namespace StudentCampus.WebApi.Services
{
    public class FakeDataService
    {
        ...
        public async Task<int> GenerateStudentDataAsync(CancellationToken cancellationToken)
        {
            var fakeStudentRules = new Faker<Student>("tr")
                ...
                .RuleFor(s => s.CreatedByUserId, f => "nejlakucuk");

            var students = fakeStudentRules.Generate(100);
